...
1. [📌 Основные возможности](#-основные-возможности)
   1. [1️⃣ Синхронизация с Yandex Tracker](#1️⃣-синхронизация-с-yandex-tracker)
3. [📡 API](#-api)  
4. [⚙️ Архитектура и контейнеры](#-архитектура-и-контейнеры)  
5. [🧩 Стек технологий](#-стек-технологий)  
6. [🔗 Интеграция с API YandexTracker](#-интеграция-с-api-yandextracker)  
   1. [1️⃣ Регистрация и доступы](#1-регистрация-и-доступы)  
   2. [2️⃣ Настройка очереди](#2-настройка-очереди)  
   3. [3️⃣ Интеграция с почтой](#3-интеграция-с-почтой)  
   4. [4️⃣ Глобальные поля](#4-глобальные-поля)  
   5. [5️⃣ Локальные поля](#5-локальные-поля)  
7. [🚀 Установка и запуск проекта в Docker](#-установка-и-запуск-проекта-в-docker)  
8. [⚙️ Запуск в режиме разработки](#-запуск-в-режиме-разработки)  
9. [🛠️ Полезные команды](#-полезные-команды)  
   1. [1️⃣ Работа с базой данных](#1-работа-с-базой-данных)  
   2. [2️⃣ Работа с Docker](#2-работа-с-docker)  
   3. [3️⃣ Настройка Gunicorn](#3-настройка-gunicorn)  
   4. [4️⃣ Проверка стиля кода](#4-проверка-стиля-кода)  
   5. [5️⃣ Управление зависимостями](#5-управление-зависимостями)  
   6. [6️⃣ Переустановить подключение через VS Code](#6-переустановить-подключение-через-vs-code)  
10. [👋 Автор](#-автор)
