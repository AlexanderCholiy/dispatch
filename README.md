...
2. [API](#-api)  
3. [Архитектура и контейнеры](#-архитектура-и-контейнеры)  
4. [Стек технологий](#-стек-технологий)  
5. [Интеграция с Yandex Tracker](#-интеграция-с-api-yandextracker)  
...
6. [Установка и запуск проекта в Docker](#-установка-и-запуск-проекта-в-docker)  
