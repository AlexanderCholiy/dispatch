...
| **СТАЖЕР** | Обладает правами диспетчера со следующими жесткими ограничениями:<br>- [ ] Не может создавать новые инциденты<br>- [ ] Не может редактировать чужие инциденты<br>- [ ] Не может переносить письма<br>- [ ] ℹ️ Для тренировок и обучения выделена изолированная тестовая опора `undefined` |
