...
@login_required
@role_required()
def grafana_general_statistics_dashboard(request: HttpRequest) -> HttpResponse:
...
@login_required
@role_required()
def grafana_general_map_dashboard(request: HttpRequest) -> HttpResponse:
    theme = request.COOKIES.get('site_theme', 'auto')
