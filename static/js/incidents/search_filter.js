document.addEventListener('DOMContentLoaded', function() {
  ...
  const elements = [
    ...
    { el: document.getElementById('incident-type-select'), name: 'incident_type' },
    { el: document.getElementById('avr-contractor-select'), name: 'avr_contractor' },
    { el: document.getElementById('region-responsible-manager-select'), name: 'region_responsible_manager' },
    { el: document.getElementById('macroregion-select'), name: 'macroregion' },
    { el: document.getElementById('operator-group-select'), name: 'operator_group' },
