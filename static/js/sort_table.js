...
document.querySelectorAll('.sort-emails-btn, .sort-users-btn, .sort-incidents-btn, .sort-energy-company-btn, .sort-notification-btn, .sort-planned-work-btn').forEach(btn => {
